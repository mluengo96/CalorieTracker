...
import com.mluengo.core.domain.model.UserInfo
...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val caloricGoal = dailyCaloryRequirement(userInfo)
    ...
    // Formula that calculates how many calories someone burns
    ...
    // Calculates daily Caloric Requirement
    private fun dailyCaloryRequirement(userInfo: UserInfo): Int {
        ...
        val caloricExtra = when(userInfo.goalType) {
